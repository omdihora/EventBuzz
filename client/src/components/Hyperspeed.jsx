...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
    ...
    useEffect(() => {
        // Check WebGL availability before attempting to initialize
        try {
    ...
    `;
        ...
        try {
            ...
            console.warn('Hyperspeed: WebGL initialization failed, using fallback.', e);
            setWebglFailed(true);
        }
    ...
    if (webglFailed) {
        return (
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: 'linear-gradient(135deg, #0a0a0a 0%, #1a1020 30%, #0d0d1a 60%, #000000 100%)' }}>
                <div style={{ position: 'absolute', top: '20%', left: '10%', width: '300px', height: '300px', background: 'radial-gradient(circle, rgba(232,114,92,0.15) 0%, transparent 70%)', borderRadius: '50%', filter: 'blur(60px)' }} />
                <div style={{ position: 'absolute', bottom: '20%', right: '15%', width: '250px', height: '250px', background: 'radial-gradient(circle, rgba(46,196,182,0.1) 0%, transparent 70%)', borderRadius: '50%', filter: 'blur(60px)' }} />
            </div>
        );
    }

    return <div id="lights" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} ref={hyperspeed}></div>;
};
